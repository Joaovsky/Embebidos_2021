...
static const char_T *emlrtEntryPoints[4] = { "environment", "exec", "getState",
  "reward" };
 ...
 * Return Type  : void
 */
void environment_mexFunction(int32_T nlhs, mxArray *plhs[3], int32_T nrhs, const
  mxArray *prhs[3])
{
  ...
  /* Call the function. */
  environment_api(prhs, nlhs, outputs);
                 ...
                 *prhs[])
{
  ...
  switch (emlrtGetEntryPointIndexR2016a(&st, nrhs, prhs, emlrtEntryPoints, 4)) {
   case 0:
    environment_mexFunction(nlhs, plhs, nrhs - 1, *(const mxArray *(*)[3])&prhs
      [1]);
    break;

   case 1:
    exec_mexFunction(nlhs, nrhs - 1);
    break;

   case 2:
    getState_mexFunction(nlhs, plhs, nrhs - 1, *(const mxArray *(*)[2])&prhs[1]);
    break;

   case 3:
    reward_mexFunction(nlhs, plhs, nrhs - 1, *(const mxArray *(*)[2])&prhs[1]);
    break;
  }
...
/*
 * File trailer for _coder_environment_mex.c
 *
 * [EOF]
 */
